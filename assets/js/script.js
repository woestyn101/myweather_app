...
var url2 = "";
 ...
 var mylat;
        ...
        return response.json();
          ...
          fetch(url2).then(function(response){
            ...
            myCity.textContent = data.city.name;      
                    ...
                    // reverse array to put last searched city first
                     theCities.reverse();                 
                ...
                // Changing image depending on weather condition

                imageChange(data.list[2].weather[0].main, currentWeatherImage)
                
              // function to change image icon depending on weather condition
                ...
                // calling image change function to change weather icon
               ...
               // calling image change function to change weather icon  
                ...
                imageChange(data.list[39].weather[0].main, day5Image)
                  ...
                  // clearing the search history of cities in local storage
  ...
  $(function () { 
        ...
        // putting all the cities arrays together
        ...
        var morecities = myCities.concat(major_uscities1, major_uscities2, major_uscities3, major_uscities4, major_uscities5, major_uscities6, major_uscities8, major_uscities9, major_uscities10, major_uscities11);
             ...
             //creating the autocompte for city search
